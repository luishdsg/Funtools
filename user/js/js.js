...
function home() {
    ...
    document.getElementById("homesvg").style.display = "block";
    document.getElementById("formsvg").style.display = "none";
    document.getElementById("skillssvg").style.display = "none";
    document.getElementById("projectsvg").style.display = "none";
}
...
function form() {
    ...
    document.getElementById("formsvg").style.display = "block";
    document.getElementById("skillssvg").style.display = "none";
    document.getElementById("projectsvg").style.display = "none";
}
...
function skills() {
    ...
    document.getElementById("skillssvg").style.display = "block";
    document.getElementById("homesvg").style.display = "none";
    document.getElementById("formsvg").style.display = "none";
    document.getElementById("projectsvg").style.display = "none";
}
...
function project() {
    ...
    document.getElementById("homesvg").style.display = "none";
    document.getElementById("formsvg").style.display = "none";
    document.getElementById("projectsvg").style.display = "block";
}
